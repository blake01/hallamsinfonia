...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Setting.facebook_link'
        db.add_column(u'hallamsinfonia_setting', 'facebook_link',
                      self.gf('django.db.models.fields.URLField')(default='facebook.com', max_length=200),
                      keep_default=False)

        # Adding field 'Setting.twitter_link'
        db.add_column(u'hallamsinfonia_setting', 'twitter_link',
                      self.gf('django.db.models.fields.URLField')(default='twitter.com', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Setting.facebook_link'
        db.delete_column(u'hallamsinfonia_setting', 'facebook_link')

        # Deleting field 'Setting.twitter_link'
        db.delete_column(u'hallamsinfonia_setting', 'twitter_link')
