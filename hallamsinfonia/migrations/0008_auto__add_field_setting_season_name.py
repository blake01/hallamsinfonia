...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Setting.season_name'
        db.add_column(u'hallamsinfonia_setting', 'season_name',
                      self.gf('django.db.models.fields.CharField')(default='2013/14', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Setting.season_name'
        db.delete_column(u'hallamsinfonia_setting', 'season_name')
